[ ![Download](https://api.bintray.com/packages/tonyofrancis/maven/dispatch/images/download.svg?version=1.0.6) ](https://bintray.com/tonyofrancis/maven/dispatch/1.0.6/link)
...
```java
implementation "com.tonyodev.dispatch:dispatch:1.0.6"
```

To use with Retrofit add
```java
    implementation "com.tonyodev.dispatch:dispatch-retrofit2-adapter:1.0.6"
```
